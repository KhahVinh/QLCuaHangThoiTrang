...
public class PhieuXuatView extends javax.swing.JPanel {
    static String [] ColumnName = {"Tên khách hàng","Số điện thoại","Ngày tạo","Tổng tiền"};
    ...
    public void updateTable() {
        Object [] dataRow = {"Phạm Văn Tùng","0344508700","2024","1000000"}; 
        dtmPhieuXuat.addRow(dataRow);
